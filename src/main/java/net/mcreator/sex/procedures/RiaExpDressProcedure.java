...
public class RiaExpDressProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z, Entity entity) {
		...
		}.compareDistOf(x, y, z)).findFirst().orElse(null)) instanceof RiastrippedexpanEntity) {
			((RiastrippedexpanEntity) ((Entity) world.getEntitiesOfClass(RiastrippedexpanEntity.class, AABB.ofSize(new Vec3(x, y, z), 8, 8, 8), e -> true).stream().sorted(new Object() {
				Comparator<Entity> compareDistOf(double _x, double _y, double _z) {
					return Comparator.comparingDouble(_entcnd -> _entcnd.distanceToSqr(_x, _y, _z));
				}
